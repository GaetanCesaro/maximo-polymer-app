...
var inspectionFormRecord = {
	  'changedate': '2017-02-26T19:10:48-05:00',
	  'hasld_localized': 'N',
	  'inspectionformid': 222,
	  'status_description': 'Draft',
	  'isrevision_localized': 'N',
	  'createdate': '2017-02-26T19:10:50-05:00',
	  'hasrevision': false,
	  'langcode': 'EN',
	  'hasrevision_localized': 'N',
	  'inspectionformstatus_collectionref': 'http://localhost:7001/maximo/oslc/os/mxapiinspform/_MTAwMS9FQUdMRU5BLzE-/inspectionformstatus',
	  'revision': 1,
	  '_rowstamp': '[0 0 0 0 0 32 -75 65]',
	  '_id': '1001-EAGLENA-1',
	  'orgid': 'EAGLENA',
	  ...
	  'inspectionformstatus': [
	    {
	      'changedate': '2017-02-26T19:10:50-05:00',
	      'changedate_localized': '2/26/17 7:10 PM',
	      'status_description': 'Draft',
	      'status': 'DRAFT',
	      'changeby': 'THEO',
	      'localref': 'http://localhost:7001/maximo/oslc/os/mxapiinspform/_MTAwMS9FQUdMRU5BLzE-/inspectionformstatus/0-112',
	      'inspectionformstatusid': 112,
	      '_rowstamp': '[0 0 0 0 0 32 -75 66]',
	      '_id': '112',
	      'name': 'TEST INSPECTION FORM',
	      'inspectionformstatusid_localized': '112',
	      'siteid': 'BEDFORD',
	      'href': 'http://childkey#SU5TUEVDVElPTkZPUk0vSU5TUEVDVElPTkZPUk1TVEFUVVMvMTEy',
	      'status_maxvalue': 'DRAFT'
	    }
	  ],
	  'personcreate': {
	  ...
	  'status_maxvalue': 'DRAFT',
	  'href': 'http://localhost:7001/maximo/oslc/os/mxapiinspform/_MTAwMS9FQUdMRU5BLzE-',
	  'personchange': {
	    'displayname': 'Theodore Seville'
	  },
	  'inspquestion_collectionref': 'http://localhost:7001/maximo/oslc/os/mxapiinspform/_MTAwMS9FQUdMRU5BLzE-/inspquestion',
	  'changedate_localized': '2/26/17 7:10 PM',
	  'status': 'DRAFT',
	  'changeby': 'THEO',
	  'createdby': 'THEO',
	  'inspectionformid_localized': '222',
	  'inspquestion': [
	    {
	      'groupseq_localized': '1.00',
	      'groupseq': 1,
	      'hasld_localized': 'N',
	      'localref': 'http://localhost:7001/maximo/oslc/os/mxapiinspform/_MTAwMS9FQUdMRU5BLzE-/inspquestion/0-121',
	      'langcode': 'EN',
	      'inspquestionnum': '1001',
	      '_rowstamp': '[0 0 0 0 0 32 -75 75]',
	      'inspquestionid_localized': '121',
	      '_id': '1001-1001-EAGLENA-1',
	      'sequence': 1,
	      'description': 'Is this a test question?',
	      'sequence_localized': '1',
	      'inspquestionid': 121,
	      'inspfield_collectionref': 'http://localhost:7001/maximo/oslc/os/mxapiinspform/_MTAwMS9FQUdMRU5BLzE-/inspquestion/0-121/inspfield',
	      'required': false,
	      'href': 'http://childkey#SU5TUEVDVElPTkZPUk0vSU5TUFFVRVNUSU9OLzEwMDEvMTAwMS9FQUdMRU5BLzE-',
	      'required_localized': 'N',
	      'hasld': false
	    }
	  ],
	  'createdate_localized': '2/26/17 7:10 PM',
	  'hasld': false,
	  'page': 'start',
